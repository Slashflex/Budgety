...
var budgetController = (function() {
    ...
    return {
        ...
        calculateBudget: function() {
            ...
            // 3. Calculate the percentage of income that are spent
    ...
    var formatNumber = function(num, type) {
        ...
        */
        ...
        if (int.length > 3) {
            ...
            // input 2310, output 2,310, input 23104, output 23,104
        }
    ...
    return {
        ...
        addListItem: function(obj, type) {
            ...
            if (type == 'inc') {
                ...
                class="item__delete--btn"><i class="icon-arrows-circle-remove"></i></button></div></div>
                </div>`;
            } else if (type === 'exp') {
                ...
                class="item__delete"><button class="item__delete--btn"><i class="icon-arrows-circle-remove">
